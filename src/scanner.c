...
bool tree_sitter_fasp_external_scanner_scan(void *payload, TSLexer *lexer,
...
void *tree_sitter_fasp_external_scanner_create() { return NULL; }
...
unsigned tree_sitter_fasp_external_scanner_serialize(void *payload,
                                                       char *buffer) {
  return 0;
}

void tree_sitter_fasp_external_scanner_deserialize(void *payload,
                                                     char *buffer,
                                                     unsigned length) {}
